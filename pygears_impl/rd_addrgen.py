...
from pygears.common import cart, cart_sync_with, ccat, quenvelope, shred, mux, union_collapse, flatten, czip, cart, dreg, decoupler
...
def rd_addrgen(*, frame_size=(25, 25)):
    ...
    sweep_out = hop_out | decoupler | sweeper(scale_ratio=ratio, frame_size=frame_size) | dreg
